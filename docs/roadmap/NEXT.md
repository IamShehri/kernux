...
## Active unit — post-bounded static fallback current-view reconciliation candidate
...
The reconciliation may only bind already-proven truth through PR #532. It must preserve PR #520 as adverse merged-but-not-closed evidence, PR #522/#523 as separately authorized and proven fix-forward remediation, PR #529 as the closed post-provider current-view reconciliation, PR #530 as the bounded fallback authorization, PR #531 as the bounded runtime implementation, and PR #532 as this reconciliation authorization.
