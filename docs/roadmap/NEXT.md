...
## Active unit — P9 bounded R1–R3 continuous-assurance core closeout candidate
...
A successor must be selected from live canonical evidence and the P8 master plan. Numbering, roadmap ordering, stale PRs, donor material, master-plan ordering, or prior chat state cannot create implementation authority.