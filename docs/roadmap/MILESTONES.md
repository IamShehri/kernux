...
## Active milestone unit — post-GitHub/CI-contract current-view reconciliation candidate

Canonical authority exists only through PR #516 / post-merge proof `5604831102`.

The only authorized candidate paths are:
