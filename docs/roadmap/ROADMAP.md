...
## Current active roadmap unit — P9-R2 post-merge current-view reconciliation candidate

Canonical authority exists through PR #561 / external post-merge proof `5611667060` only for this exact five-path documentation reconciliation.
...
The bounded P9-R1 and P9-R2 meaning is preserved:
