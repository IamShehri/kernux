...
The only active P8 roadmap unit in this view is the exact five-path reconciliation authorized by PR #532 / post-merge proof `5608141441`.
...
The candidate may bind only already-proven truth through PR #532 and cannot certify its own closure.
