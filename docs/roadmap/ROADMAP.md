...
P9_R3_POST_MERGE_CURRENT_VIEW_RECONCILIATION = CURRENT_CANDIDATE / NOT_YET_CLOSED_CANONICAL
...
## Current active roadmap unit — P9-R3 post-merge current-view reconciliation candidate

Canonical authority exists through PR #565 / external post-merge proof `5620394928` only for this exact five-path documentation reconciliation.
...
No sixth path is authorized. P9-R1, P9-R2, and P9-R3 source, test, schema, authorization, and implementation evidence remain frozen. P9-R1 indexed blobs remain source `7114a87ecc465d08d524252834f414203dc96a43`, test `e2b54db06c5e550f8468d2d1f65a696facd471d6`, and schema `0c3e11a69b526e7505924a637b867f146d3158ac`; PR #556 correction `5611187213` remains authoritative for those Git blob identities. P9-R2 blobs remain source `a0671a84d5d7c480f30577f992de1e469eff394f`, test `fcd530aca45332548e2b71b08ac0ec680f7bd092`, and schema `092b84387f2995f8522527a1fdb83e3f20391a4d`. P9-R3 blobs remain source `b32888f62be258b66c1825e2fa05500c17bb7d27`, test `6e1e5575e239d3b0e280cbc7c2122e49f076438f`, and schema `d36c76d8dcd5684badc96189e88879047a8682a5`.
...
The bounded P9-R1, P9-R2, and P9-R3 meaning is preserved:
